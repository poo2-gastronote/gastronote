...
public class FormIngrediente extends javax.swing.JFrame {
    private static FormIngrediente cadIngrediente;
    ...
    //método Singleton
    public static FormIngrediente getCadIngrediente(){
        if(cadIngrediente == null){
            cadIngrediente = new FormIngrediente();
        } 
        return cadIngrediente;
    }
